...
export const HomepageLeft = ():JSX.Element => {
    return <div className={styles.homepage_left_cont}>
        <div className={styles.homepage_left_cont_top}>
            <ul>
                <li className={styles.homepage_left_cont_top_top}>
        ...
        <div  className={styles.homepage_left_cont_mid}>
            <button>Tweet</button>
        </div>
        <div  className={styles.homepage_left_cont_bottom}>
            <div>
                <span><img src={myProfile.img} alt=""/></span>
                <span>
                    <p><strong>Somesh Kumar Yadav</strong></p>
                    <p>@SomeshKumarYa12</p>
                </span>
                <span>
                    <svg viewBox="0 0 24 24" aria-hidden="true">
